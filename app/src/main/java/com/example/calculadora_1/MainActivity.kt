...
import com.example.calculadora_1.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.multp.setOnClickListener {
            calculo.text = "${calculo.text}*"
        }
        binding.parentAbrindo.setOnClickListener {
            calculo.text = "${calculo.text}("
        }
        binding.parentFechando.setOnClickListener {
            calculo.text = "${calculo.text})"
        }
